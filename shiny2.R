...
server <- function(input, output) {
    ...
    output$select_var1 <- renderUI({
        ...
        selectizeInput('var1', 'Select Name', choices = c("select" = "", levels(app_data$name.x)),selected = NULL)
    ...
    output$select_var2 <- renderUI({
        ...
        selectizeInput('var2', 'Select State', choices = c("select" = "", choice_var2()),selected = NULL)
    ...
    output$select_var3 <- renderUI({
        ...
        selectizeInput('var3', 'Select Restaurant', choices = c("select" = "", choice_var3()),selected = NULL)
